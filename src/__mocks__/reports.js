  ...
  const orders = [
    ...
    },
    {
      ...
      createdAt: moment()
        ...
        .getTime(),
      customer: {
        email: 'alex.richardson@testEmail.com',
        name: 'Alex Richardson'
      },
      currency: '$',
      items: 4,
    ...
    },
    {
      ...
      createdAt: moment()
        ...
        .getTime(),
      customer: {
        email: 'anje.keiser@testEmail.com',
        name: 'Anje Keizer'
      },
      currency: '$',
      items: 1,
    ...
    },
    {
      ...
      customer: {
        ...
        email: 'clarke.gillebert@testEmail.com'
      },
      currency: '$',
      items: 5,
      number: 'DEV-1038',
    ...
    },
    {
      ...
      createdAt: moment()
        ...
        .getTime(),
      customer: {
        email: 'merrile.burgett@testEmail.com',
